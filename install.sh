...
if wget -q https://github.com/anthony2303/cap-/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/anthony2303/cap-.git
...
menu_ayuda() {
	...
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/IkmoGgRSDi46dOTiH1EF74 &>> /dev/null
